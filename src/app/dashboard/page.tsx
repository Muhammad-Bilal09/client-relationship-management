...
export default function Page() {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row">
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 z-30 h-full bg-white shadow-lg transition-transform md:transition-transform md:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        } lg:relative lg:translate-x-0 lg:w-64 w-64 md:w-56`}
        style={{ padding: "32px 16px", gap: "32px" }}
      >
...
//   const handlePageClick = (pageName:any) => {
//     setCurrentPage(pageName);
//     if (sidebarOpen) {
//       setSidebarOpen(false);
//     }
...
//       </div>
//       <div
//         className={`fixed top-0 left-0 z-30 h-full lg:mx-[40px] bg-white shadow-lg transition-transform rounded-lg md:translate-x-0 ${
//           sidebarOpen ? "translate-x-0" : "-translate-x-full"
//         } md:w-64 md:w-56 w-64`}
//         style={{ width: "220px", padding: "32px 16px", gap: "32px" }}
//       >
//         <div className="p-4 flex items-center justify-between">
//           <h2 className="text-2xl font-semibold">
//             swift<span className="text-purple">CRM</span>
