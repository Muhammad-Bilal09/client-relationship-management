...
export default function CreateDocumentPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button
        onClick={openModal}
        className="flex justify-end text-purple border border-purple hover:underline"
      >
        Create Document
      </button>
      <div className="container mx-auto p-4">
          ...
          <table className="mt-5 min-w-full divide-y divide-gray-200 shadow-md overflow-hidden sm:rounded-lg">
            <thead className="bg-gray-50">
              <tr className="text-left uppercase bg-purple text-white">
                <th className="py-3 px-6 text-xs font-medium">Title</th>
                <th className="py-3 px-6 text-xs font-medium">Type</th>
                <th className="py-3 px-6 text-xs font-medium">Date</th>
                <th className="py-3 px-6 text-xs font-medium">Description</th>
                <th className="py-3 px-6 text-xs font-medium">File</th>
              </tr>
            </thead>
      ...
      <Modal isOpen={isModalOpen} closeModal={closeModal}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="mt-4 flex bg-purple text-white px-4 py-2 rounded-md hover:bg-purple-dark"
            disabled={isLoading}
          >
