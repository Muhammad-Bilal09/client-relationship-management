      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead>
          <tr className="bg-purple text-white">
            <th className="px-4 py-2 text-left text-sm font-medium text-white font-heading">Image</th>
            <th className="px-4 py-2 text-left text-sm font-medium text-white font-heading">Title</th>
            <th className="px-4 py-2 text-left text-sm font-medium text-white font-heading">Price</th>
            <th className="px-4 py-2 text-left text-sm font-medium text-white font-heading">Quantity</th>
            <th className="px-4 py-2 text-left text-sm font-medium text-white font-heading">Actions</th>
          </tr>
        </thead>
