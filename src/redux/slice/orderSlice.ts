...
const orderSlice = createSlice({
  ...
  initialState,
  reducers: {
    setUserDetails: (state, action: PayloadAction<Partial<OrderState["userDetails"]>>) => {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchOrders.fulfilled, (state, action: PayloadAction<Orders[]>) => {
      ...
      .addCase(createOrder.fulfilled, (state, action: PayloadAction<Orders>) => {
...
export const { setUserDetails, setSelectedCountry, clearOrder } = orderSlice.actions;
